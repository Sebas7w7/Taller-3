...
class MultStrassenParTest extends AnyFunSuite {
  ...
  test("Multiplicación de matrices 4x4 con números positivos") {
    val resultado = taller3.multStrassenPar(matriz1, matriz2)
    println(resultado)
  ...
  test("Multiplicación de una matriz con una matriz de ceros") {
    assert(taller3.multStrassenPar(matriz1, matrizCero) == matrizCero)
  }
  ...
  test("Multiplicación de matrices con valores cancelados") {
    ...
    assert(taller3.multStrassenPar(matrizMaximos, matrizMinimos) == resultadoEsperado)
  }

  test("Multiplicación de matrices con elementos negativos") {
    val resultado = taller3.multStrassenPar(matrizNegativa, matriz2)
  ...
  test("Multiplicación de matrices con elementos mixtos (positivos y negativos)") {
    val resultado = taller3.multStrassenPar(matrizMixta, matriz2)
